...
gspro_file = "/home/duch/shipping/speciate/S2S-Tool/output/gspro.CB7_AE7_CRITERIA_VOC.CMAQ.2025-06-29.txt"
profile_id = "121GROC"  # the emission profile used for ship emissions
output_nc_file = input_nc_file.replace(".nc", "_cb7ae7_speciated.nc")
