...
keywords = ["marine", "Marine", "Vessel", "vessel", "barge", "port", "ferry", "Ferry"]
pattern = '|'.join(keywords)
shipping_profiles = profiles[
    profiles['PROFILE_NAME'].str.contains(pattern, case=False, na=False) &
    (profiles['PROFILE_TYPE'].str.upper() == 'PM')
...
print(merged[["SPECIES_ID", 'SPECIES_NAME', 'WEIGHT_PERCENT', 'NMVOC_apportioned']].head(15))
...
output_excel = f"shipping_profile_{profile_code}_speciated_PM.xlsx"
