...
# Check with plot rather than netcdf
...
axs[0].set_title(f"ds_out — {var_to_plot}")

# Plot gdf_arrayshort
gdf_arrayshort[var_to_plot].plot(ax=axs[1], cmap="viridis")
axs[1].set_title(f"gdf_arrayshort — {var_to_plot}")
